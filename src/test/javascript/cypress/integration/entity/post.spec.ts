...
describe('Post e2e test', () => {
  ...
  const postSample = { title: 'B2C', content: 'Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci50eHQ=', date: '2022-03-18T19:19:49.555Z' };
  ...
  describe('new Post page', () => {
    ...
    it('should create an instance of Post', () => {
      ...
      cy.get(`[data-cy="date"]`).type('2022-03-18T20:44').should('have.value', '2022-03-18T20:44');
